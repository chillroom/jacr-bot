...
module.exports = {
	...
	request: "Requesting a command :  https://bitbucket.org/dubbot/dubbot/issues?status=new&status=open",
	requests: "Requesting a command :  https://bitbucket.org/dubbot/dubbot/issues?status=new&status=open",
	suggest: "Suggesting a command :  https://bitbucket.org/dubbot/dubbot/issues?status=new&status=open",
	suggestion: "Suggesting a command :  https://bitbucket.org/dubbot/dubbot/issues?status=new&status=open",
