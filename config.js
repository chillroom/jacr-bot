module.exports = {
	...
	APIMongoURL: process.env.API_MONGO_URL || "mongodb://apiserver:AP1s3v3r1502@ds027825.mongolab.com:27825/illumibot",
	jenkinsUser: process.env.JENKINS_USER || "admin",
	jenkinsToken: process.env.JENKINS_TOKEN || "9b073803068893f6782567207d8e1338",
	jenkinsURL: process.env.JENKINS_SITE || "jenkins-nitroghost.rhcloud.com/job/betabot-build"
};
