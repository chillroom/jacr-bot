...
module.exports = function (bot, data) {
	...
	if (typeof (data.params) !== "undefined" && data.params.length > 0) {
		if (data.params.length === 1 && data.params[0] === ("help" || "h")) {
			bot.sendChat("you can check the time of any town, city anywhere in the world by doing: !time [in | is it in | for] [location]. You may want to be specific with locations like: \"London, Canada\" for best results");
		} else {
